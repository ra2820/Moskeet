...
file_to_run = 'wandb agent --count 1 mosquito/Moskeet-Endtoendapproach_Endtoendapproach/u7hr70dx'#'python /vol/bitbucket/hgc19/mosquito/Moskeet/Endtoendapproach/main.py' # swap main.py with your script

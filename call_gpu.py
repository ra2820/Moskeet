...
file_to_run = 'wandb agent --count 1 mosquito/Moskeet-Endtoendapproach_Endtoendapproach/41cso9g9'#'python /vol/bitbucket/hgc19/mosquito/Moskeet/Endtoendapproach/main.py' # swap main.py with your script

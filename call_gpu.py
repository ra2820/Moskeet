...
file_to_run = 'wandb agent --count 1 mosquito/Moskeet-Endtoendapproach_Endtoendapproach/syn65nd9'#'python /vol/bitbucket/hgc19/mosquito/Moskeet/Endtoendapproach/main.py' # swap main.py with your script
